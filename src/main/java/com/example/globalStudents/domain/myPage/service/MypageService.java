...
public interface MypageService {
    MypageResponseDTO.MypageDTO getMyPage(String userId);
    MypageResponseDTO.MypageInfoDTO getUserInfo(String userId);
    MypageResponseDTO.MypageProfileDTO getUserProfile(String userId);
    MypageRequestDTO.MypageInfoUpdateDTO updateUserInfo(String userId, MypageRequestDTO.MypageInfoUpdateDTO requestDTO);
